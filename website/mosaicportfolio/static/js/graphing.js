...
$(
    ...
    function(){
        ...
        function getUserGraphData(user){
            return {
                title: "TITLE", width: 600, height:400, vTitle: "vTitle", hTitle: "hTitle",
                table: [
        ...
        google.setOnLoadCallback(function(){
                                     data = getUserGraphData('esbena');
                                     drawVisualization(data.table, data.title, 'graph', data.width, data.height, data.vTitle, data.hTitle);
                                 }
                                );
    });
